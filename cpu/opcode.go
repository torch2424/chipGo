...
func DecodeOpcode(cpu Cpu) Cpu {
    ...
    case 0x8000:
        ...
        switch opCode & 0x000F {
            ...
            case 0x0004:
                ...
                cpu.registers[regX] = uint8(result)
                break
            case 0x0005:
                //regx = Subtract regX and regY. RegF (Carry flag) is set to 1 if there is a borrow. 0 if there is not
            ...
            case 0x0006:
                ...
                break
            case 0x0007:
                //regx = Subtract regY and regX. RegF (Carry flag) is set to 1 if there is a borrow. 0 if there is not
    ...
    case 0xF000:
        ...
        case 0x0029:
            ...
            cpu.indexRegister = uint16(0x50) + uint16(cpu.registers[regX]) * uint16(4)
            break
        case 0x033:
            ...
            //Hundreds
            cpu.chipMemory[cpu.indexRegister] = cpu.registers[regX] /  100 % 10

            //tenths
            cpu.chipMemory[cpu.indexRegister + 1] = (cpu.registers[regX] / 10) % 10

            //Single
            cpu.chipMemory[cpu.indexRegister + 2] = (cpu.registers[regX] % 10)
            break
        case 0x0055:
